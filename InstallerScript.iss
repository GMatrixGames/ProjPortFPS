...
#define MyAppName "Quantum Raiders"
#define MyAppVersion "1.0-Beta"
#define MyAppPublisher "TE4M GAMES"
#define MyAppURL "https://quantumraiders.genxgames.gg"
#define MyAppExeName "Quantum Raiders.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{1161C3E2-38AB-4A6B-8758-8EB90A0BD7D4}
AppName={#MyAppName}
...
OutputBaseFilename=QuantumRaidersSetup
SetupIconFile=D:\Personal Projects\FS\ProjPortFPS\QuantumRaidersIcon.ico
Compression=lzma
